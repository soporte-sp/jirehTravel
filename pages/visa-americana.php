                ...
                <div class="visa-content">
                    <header class="content-heading-visa">
                        ...
                        <p class="main-subtitle-visa">
                            ...
                            <span style="color: #3f3e3e; font-weight: 500;">Estados Unidos,</span> 
                            desde el inicio de tu solicitud y entrega de documentos hasta la 
                            respuesta de la embajada, brindándote acompañamiento permanente. 
                        </p>
                        <div
                            class="seperator"
                            style="padding-bottom: 20px; border-bottom: 1px solid #e2e2e2;"></div>
                    </header>
                                            ...
                                            <li style="box-shadow: none; border: none;">
                                                ...
                                                <div class="slide">
                                                    <div class="slide-holder" style="padding: .9rem 0 0 0; margin: 0; text-align: start; font-size: 1.7rem;">
                                                        <strong style="color: rgb(102,102,102);">Documentos del solicitante</strong>
                                                        <ul class="ul-li-marker" style="padding: 0; list-style: none;">
                                                            ...
                                                            <li style="line-height: 1.2; margin: 0;">• Foto en formato digital 5x5cm vigente a color y en fondo blanco*.</li>
                                                    ...
                                                    <div class="slide-holder" style="padding: .9rem 0 0 0; margin: 0; text-align: start; font-size: 1.7rem;">
                                                        <ul class="ul-li-marker" style="padding: 0; list-style: none;">
                                                            <li style="line-height: 1.2; margin: .5rem 0 2rem;">
                                                                ...
                                                                sobre el estado de su solicitud y respondiendo sus consultas para brindarle 
                                                                tranquilidad hasta el final del servicio.
                                                            </li>
                                                            <li style="line-height: 1.2; margin: .5rem 0 2rem;">
