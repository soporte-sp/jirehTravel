...
<<<<<<< HEAD
    ...
    <nav class="navbar navbar-default">
      <div class="navbar-header">
        <button type="button" class="navbar-toggle nav-opener collapsed" data-toggle="collapse" data-target="" aria-expanded="false"> <!--data-target="#nav" asi va-->
              ...
              <div class="drop-wrap">
                <div class="five-col">
                  <div class="column">
                    ...
                    <ul class="header-link" style="position: absolute; top: -9999px; left: -9999px; width: 225px;">
        ...
        <div class="trip-form trip-form-v2 trip-search-main">
          <div class="trip-form-wrap">
            ...
            <div class="holder">
              ...
              <div class="select-holder">
                <select class="trip-select trip-select-v2 region jcf-hidden" name="region" id="select-region">
                ...
                </select><span class="jcf-select jcf-unselectable jcf-select-trip-select jcf-select-trip-select-v2 jcf-select-region"><span class="jcf-select-text"><span class="">Africa</span></span><span class="jcf-select-opener"></span></span>
              </div>
            </div>
            <div class="holder">
              <label for="select-activity">Select Activity</label>
              <div class="select-holder">
                <select class="trip-select trip-select-v2 acitvity jcf-hidden" name="activity" id="select-activity">
                ...
                </select><span class="jcf-select jcf-unselectable jcf-select-trip-select jcf-select-trip-select-v2 jcf-select-acitvity"><span class="jcf-select-text"><span class="">Holiday Type</span></span><span class="jcf-select-opener"></span></span>
              </div>
            </div>
            <div class="holder">
              <label for="price-range">Price Range</label>
              <div class="select-holder">
                <select class="trip-select trip-select-v2 price jcf-hidden" name="activity" id="price-range">
                ...
                </select><span class="jcf-select jcf-unselectable jcf-select-trip-select jcf-select-trip-select-v2 jcf-select-price"><span class="jcf-select-text"><span class="">Price Range</span></span><span class="jcf-select-opener"></span></span>
              </div>
            </div>
            <div class="holder">
